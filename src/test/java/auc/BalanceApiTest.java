...
/**
 * Тесты для эндпоинтов управления балансами пользователей.
 * <p>
 * Включает CRUD операции с балансами, валидацию прав доступа и проверку соответствия
 * OpenAPI спецификации. Содержит тест, документирующий БАГ в эндпоинте UPDATE
 * (requestBody не принимается согласно спецификации).
 * </p>
 */
