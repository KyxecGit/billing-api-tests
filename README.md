...
### 📋 [TEST_CASES.md](./TEST_CASES.md) - НОВОЕ!
...
- Справочник при добавлении новых тестов
- Руководство для понимания каждого тест-кейса
- Чек-лист при регрессионном тестировании

### 🐛 [BUG_REPORTS.md](./BUG_REPORTS.md) - НОВОЕ!
...
- **Шаблоны** для добавления новых багов

**Используйте этот документ как:**
- Справочник при работе с известными проблемами API
- Основу для создания issue на GitHub/Jira
- Документацию для разработчиков
- Отчёт для stakeholders
